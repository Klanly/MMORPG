...
function WorldMapDBModel.Init()
    ...
    for i = 3, gameDataTable.Row - 1, 1 do
        worldmapTable[#worldmapTable+1] = WorldMapEntity.New( gameDataTable.Data[i][1], gameDataTable.Data[i][2], tonumber(gameDataTable.Data[i][3]), gameDataTable.Data[i][4], gameDataTable.Data[i][5], tonumber(gameDataTable.Data[i][6]) );
    end
