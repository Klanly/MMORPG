SkillEntity = { Id = 0, SkillName = "", SkillDesc = "", EffectName = "", SkillIconFolder = "", SkillIconName = "", LevelLimit = 0, IsPhyAttack = 0, AttackTargetCount = 0, AttackRange = 0, AreaAttackRadius = 0, ShowEffectDelay = 0, ShowHurtEffectDelaySecond = 0, RedScreen = 0, AttackState = 0, AbnormalState = 0, BuffInfoID = 0, BuffTargetFilter = 0, BuffIsPercentage = 0 }

--这句是重定义元表的索引，就是说有了这句，这个才是一个类
SkillEntity.__index = SkillEntity;

function SkillEntity.New(Id, SkillName, SkillDesc, EffectName, SkillIconFolder, SkillIconName, LevelLimit, IsPhyAttack, AttackTargetCount, AttackRange, AreaAttackRadius, ShowEffectDelay, ShowHurtEffectDelaySecond, RedScreen, AttackState, AbnormalState, BuffInfoID, BuffTargetFilter, BuffIsPercentage)
    local self = { }; --初始化self
