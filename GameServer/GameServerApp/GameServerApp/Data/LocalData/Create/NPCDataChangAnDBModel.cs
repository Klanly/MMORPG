...
/// NPCDataChangAn数据管理
/// </summary>
public partial class NPCDataChangAnDBModel : AbstractDBModel<NPCDataChangAnDBModel, NPCDataEntity>
{
    /// <summary>
    /// 文件名称
    /// </summary>
    protected override string FileName { get { return "NPCDataChangAn.data"; } }
