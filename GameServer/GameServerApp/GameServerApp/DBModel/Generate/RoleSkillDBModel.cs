...
public partial class RoleSkillDBModel : MFAbstractSQLDBModel<RoleSkillEntity>
{
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "RoleId", "SkillId", "SkillLevel", "SlotsNode", "CreateTime", "UpdateTime" };
            }
            return _ColumnList;
        }
    }
    ...
    protected override SqlParameter[] ValueParas(RoleSkillEntity entity)
    {
        SqlParameter[] parameters = new SqlParameter[] {
                ...
                new SqlParameter("@SlotsNode", entity.SlotsNode) { DbType = DbType.Byte },
        ...
        foreach (DataRow row in table.Rows)
        {
            ...
            switch (colName.ToLower())
            {
                ...
                case "skilllevel":
                    ...
                    break;
                case "slotsnode":
                    if (!(reader["SlotsNode"] is DBNull))
                        entity.SlotsNode = Convert.ToByte(reader["SlotsNode"]);
                    break;
                case "createtime":
