...
public partial class Role_BackpackDBModel : MFAbstractSQLDBModel<Role_BackpackEntity>
{
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "RoleId", "GoodsType", "GoodsId", "GoodsCount", "GoodsSvrId", "CreateTime" };
            }
            return _ColumnList;
        }
    }
    ...
    protected override SqlParameter[] ValueParas(Role_BackpackEntity entity)
    {
        SqlParameter[] parameters = new SqlParameter[] {
                ...
                new SqlParameter("@GoodsSvrId", entity.GoodsSvrId) { DbType = DbType.Int32 },
        ...
        foreach (DataRow row in table.Rows)
        {
            ...
            switch (colName.ToLower())
            {
                ...
                case "goodscount":
                    ...
                    break;
                case "goodssvrid":
                    if (!(reader["GoodsSvrId"] is DBNull))
                        entity.GoodsSvrId = Convert.ToInt32(reader["GoodsSvrId"]);
                    break;
                case "createtime":
