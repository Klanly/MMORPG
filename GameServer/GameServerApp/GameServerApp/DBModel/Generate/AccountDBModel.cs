...
public partial class AccountDBModel : MFAbstractSQLDBModel<AccountEntity>
{
    ...
    protected override IList<string> ColumnList
    {
        get
        {
            if (_ColumnList == null)
            {
                _ColumnList = new List<string> { "Id", "Status", "UserName", "Pwd", "Mobile", "Mail", "Money", "ChannelId", "LastLogOnServerId", "LastLogOnServerName", "LastLogOnServerTime", "LastLogOnRoleId", "LastLogOnRoleNickName", "LastLogOnRoleJobId", "UpdateTime", "CreateTime", "DeviceIdentifier", "DeviceModel" };
            }
            return _ColumnList;
        }
    }
