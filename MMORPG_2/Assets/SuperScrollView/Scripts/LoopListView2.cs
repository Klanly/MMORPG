...
namespace SuperScrollView
{
    ...
    public class LoopListView2 : MonoBehaviour, IBeginDragHandler, IEndDragHandler, IDragHandler
    {
        ...
        /// <summary> LoopListView2组件初始化函数 </summary>
        /// <param name="itemTotalCount">
        /// listview中的item总个数,如果将该参数设置为-1,则表示无限项,并且不支持滑动条,索引可以从-MaxInt 到+MaxInt
        /// 如果参数值>=0，支持滑动条,索引可以从0到itemTotalCount-1
        /// </param>
        /// <param name="onGetItemByIndex">当列表进入ScrollRect视图时,该操作将以列表Index作为参数调用,更新视图内的item</param>
