...
public class FightingUtil
{
    ...
    /// <summary> 计算角色战斗力 </summary>
    /// <param name="hp">最大血量</param>
    /// <param name="attack">攻击力</param>
    /// <param name="attackAdd">攻击力加成</param>
    /// <param name="def">防御</param>
    /// <param name="defAdd">防御加成</param>
    /// <param name="res">抗性</param>
    /// <param name="resAdd">抗性加成</param>
    /// <param name="hit">命中</param>
    /// <param name="hitAdd">命中加成</param>
    /// <param name="dodge">闪避</param>
    /// <param name="dodgeAdd">闪避加成</param>
    /// <param name="cri">暴击</param>
    /// <param name="criAdd">暴击加成</param>
    /// <returns></returns>
    public static int CalculateRoleFighting(int hp,int attack,int attackAdd,int def,int defAdd,int res,int resAdd,int hit,int hitAdd,int dodge,int dodgeAdd,int cri,int criAdd)
    {
        int fighting = 0;
