...
public class CameraCtrl : MonoBehaviour 
{
    ...
    {
        StartCoroutine(DoCameraShakePosition(delay,duration,strength,vibrato));
    }
    ...
    /// <param name="vibrato">振幅</param>
    /// <returns></returns>
    private IEnumerator DoCameraShakePosition(float delay = 0.5f,float duration = 1f, float strength = 1, int vibrato = 10)
    {
