...
function WorldMapDBModel.Init()
    ...
    for i = 3, gameDataTable.Row - 1, 1 do
        worldmapTable[#worldmapTable+1] = WorldMapEntity.New( gameDataTable.Data[i][1], gameDataTable.Data[i][2], gameDataTable.Data[i][3], tonumber(gameDataTable.Data[i][4]), gameDataTable.Data[i][5], gameDataTable.Data[i][6], tonumber(gameDataTable.Data[i][7]), tonumber(gameDataTable.Data[i][8]) );
    end
