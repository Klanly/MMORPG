...
function MonsterDBModel.Init()
    ...
    for i = 3, gameDataTable.Row - 1, 1 do
        monsterTable[#monsterTable+1] = MonsterEntity.New( gameDataTable.Data[i][1], tonumber(gameDataTable.Data[i][2]), tonumber(gameDataTable.Data[i][3]), tonumber(gameDataTable.Data[i][4]), tonumber(gameDataTable.Data[i][5]), tonumber(gameDataTable.Data[i][6]), tonumber(gameDataTable.Data[i][7]), tonumber(gameDataTable.Data[i][8]), tonumber(gameDataTable.Data[i][9]), tonumber(gameDataTable.Data[i][10]), tonumber(gameDataTable.Data[i][11]), tonumber(gameDataTable.Data[i][12]), tonumber(gameDataTable.Data[i][13]), tonumber(gameDataTable.Data[i][14]), tonumber(gameDataTable.Data[i][15]), tonumber(gameDataTable.Data[i][16]), tonumber(gameDataTable.Data[i][17]), tonumber(gameDataTable.Data[i][18]), tonumber(gameDataTable.Data[i][19]), gameDataTable.Data[i][20], gameDataTable.Data[i][21], gameDataTable.Data[i][22], gameDataTable.Data[i][23], gameDataTable.Data[i][24], gameDataTable.Data[i][25], tonumber(gameDataTable.Data[i][26]), tonumber(gameDataTable.Data[i][27]) );
    end
