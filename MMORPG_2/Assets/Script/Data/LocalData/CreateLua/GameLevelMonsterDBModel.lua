...
function GameLevelMonsterDBModel.Init()
    ...
    for i = 3, gameDataTable.Row - 1, 1 do
        gamelevelmonsterTable[#gamelevelmonsterTable+1] = GameLevelMonsterEntity.New( tonumber(gameDataTable.Data[i][1]), tonumber(gameDataTable.Data[i][2]), tonumber(gameDataTable.Data[i][3]), tonumber(gameDataTable.Data[i][4]), tonumber(gameDataTable.Data[i][5]), tonumber(gameDataTable.Data[i][6]), tonumber(gameDataTable.Data[i][7]), tonumber(gameDataTable.Data[i][8]), tonumber(gameDataTable.Data[i][9]), tonumber(gameDataTable.Data[i][10]) );
    end
